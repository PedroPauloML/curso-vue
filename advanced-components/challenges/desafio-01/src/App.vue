<template>
  <div id="app">
    <span>
      <button @click="component = 'Vermelho'" class="vermelho">
        Carregar Componente Vermelho
      </button>
      <button @click="component = 'Verde'" class="verde">
        Carregar Componente Verde
      </button>
      <button @click="component = 'Azul'" class="azul">
    ...
    <keep-alive>
      <component :is="component">
        <span slot="color">{{ component }}</span>
      </component>
    </keep-alive>
  </div>
</template>
